    ...
    @if (count($comments))
        <x-filament::grid class="gap-4">
            @foreach ($comments as $comment)
                <div class="fi-in-repeatable-item block rounded-xl bg-white p-4 shadow-sm ring-1 ring-gray-950/5">
                    <div class="flex gap-x-3">
                        ...
                        <div class="flex-grow space-y-2 pt-[6px]">
                            ...
                            <div class="prose [&>*]:mb-2 [&>*]:mt-0 [&>*:last-child]:mb-0 prose-sm text-sm leading-6 text-gray-950">
